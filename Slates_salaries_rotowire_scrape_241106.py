...
def is_thu_mon_classic_slate(slate_id):
    ...
    response = requests.get(base_url + str(slate_id))
...
if __name__ == "__main__":
    ...
    week = 18
    # Step 1. Find the latest valid 'Thu-Mon Classic' slate
    # latest_slate_id = find_latest_slate()
    # print(latest_slate_id)
    
    latest_slate_id = 8150
    # # Step 2. Fetch and append data for the latest slate if found
    if latest_slate_id:
